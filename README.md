...
- Atlas: (Vector) - De facto polity extents from 3000BC-2026AD, GeoJSON. Sub-yearly resolution. De jure polity extents from C-Shapes 2.0.
  ...
  - **Note.** Daily resolution keyframes are available upon request from [Confoederatio Datavault](https://datavault.confoederatio.org/). Only simplified or compressed versions are uploaded here.
